...
def test_step(batch_size,
	...
	return mask, test_loss, test_reg_loss, tv_loss, contrast_loss, test_accuracy, att_weight, corrects
...
def main():
	...
	lstm_action = Action_Att_LSTM(input_size=2048, hidden_size=512, output_size=101, seq_len=FLAGS.num_segments).cuda() 
	...
	#log_name = "tmp"
	log_dir = os.path.join('./Conv_thumos14_tensorboard', log_name)
	#log_dir = "tmp"
