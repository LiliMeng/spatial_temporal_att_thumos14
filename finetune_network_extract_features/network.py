...
def resnet101_pretrain_UCF101(pretrained=True, channel=3, **kwargs):

    org_model = resnet101(pretrained=True, channel=3)
...
if __name__ == '__main__':
    model = resnet101_pretrain_UCF101(pretrained=True, channel=3)
    print(model)
