...
def resnet18(pretrained=False, channel= 20, num_classes=51, **kwargs):
...
def resnet34(pretrained=False, channel= 20, num_classes=51, **kwargs):

    model = ResNet(BasicBlock, [3, 4, 6, 3], nb_classes=num_classes, channel=channel, **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, channel= 20, num_classes=51, **kwargs):

    model = ResNet(Bottleneck, [3, 4, 6, 3], nb_classes=num_classes, channel=channel, **kwargs)
    if pretrained:
...
def resnet152(pretrained=False, num_classes=51, **kwargs):
